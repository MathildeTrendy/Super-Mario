public class Map {
    ...
    public void createRooms() {
        ...
        Room room7 = new Room("King Bowser Koopa land", "Finally, you have reached the terrifying land of King Bowser Koopa. Bowser's land is gloomy, scary, dark and generally unpleasant. " +
